        ...
        <div class="mx-auto max-w-screen-md sm:text-center">
            <form action="#">
                ...
                <?php if(request('author')): ?>
                    <input type="author" name="category" value="<?php echo e(request('author')); ?>">
                <?php endif; ?>
                <div class="items-center mx-auto mb-3 space-y-4 max-w-screen-sm sm:flex sm:space-y-0">
                    ...
                    <div>
                        <button type="submit"
                            class="my-4 py-3 px-5 w-full text-sm font-medium text-center text-white rounded-lg border cursor-pointer bg-primary-700 border-primary-600 sm:rounded-none sm:rounded-r-lg hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Search</button>
                    </div>
                </div>
            </form>
        </div>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <article
                    ...
                    <div class="flex justify-between items-center">
                        <a href="/post?author=><?php echo e($post->author->username); ?>">
                ...
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div>
                        <p class="font-semibold"text-xl 2, my-4>Article not found!</p>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\myLaravel\resources\views/posts.blade.php ENDPATH**/ ?>
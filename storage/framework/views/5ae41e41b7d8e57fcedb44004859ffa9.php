...
<?php $component->withAttributes([]); ?>
        ...
        <div class="container mx-auto px-4 mt-6">
            ...
            <section class="bg-white dark:bg-gray-900 py-8 rounded-lg">
            ...
            <div
                class="w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mt-6">
                <div class="sm:hidden">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\myLaravel\resources\views/home.blade.php ENDPATH**/ ?>
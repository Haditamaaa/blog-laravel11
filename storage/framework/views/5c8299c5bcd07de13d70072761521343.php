        ...
        <div class="flex h-16 items-center justify-between">
            <div class="flex items-center">
                <div class="flex-shrink-0">
                    <img class="h-40" src="<?php echo e(asset('storage/img/mylogo.png')); ?>"
                        alt="Your Company">
                </div>
...
<?php endif; ?>
        ...
        <div class="border-t border-gray-700 pb-3 pt-4">
            <div class="flex items-center px-5">
                ...
                <div class="ml-3">
                    <div class="text-base font-medium leading-none text-white">Surya Haditama</div>
                    <div class="text-sm font-medium leading-none text-gray-400">Haditama@gmail.com</div>
                </div>
            </div>
...
<?php /**PATH C:\laragon\www\myLaravel\resources\views/components/navbar.blade.php ENDPATH**/ ?>